import 'dart:convert';
import 'dart:math';
import 'package:isaac_roberts_consulting/chatgpt/api/api_key.dart';
import 'package:isaac_roberts_consulting/chatgpt/controller/user_controller.dart';
import 'package:isaac_roberts_consulting/chatgpt/model/conversation_model.dart';
...
class ChatController extends GetxController {
  ...
  Future postRequestToChatGPT() async {
    ...
    var body = jsonEncode({
      "model": "gpt-3.5-turbo",
      "messages": [
        {"role": "user", "content": chats[chatIndex].prompt}
      ],
      "temperature": 0.7,
      "max_tokens": 500
    });
    try {
      ...
      if (response.statusCode == 200) {
        ...
        addChatGPTMessage(data["choices"][0]["message"]['content']);
      } else {
