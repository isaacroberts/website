...
const String imageBg = 'images/natalia-blauth-nhn5V8vLkJA-unsplash.jpg';
...
class _SignupFormState extends State<SignupForm> {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      if (constraints.maxWidth > watchSize) {
        return Padding(
            ...
            child: SizedBox(
                height: 600, width: Device.width, child: imgStack(context)));
      } else {
        return Container(
          decoration: BoxDecoration(
              image: DecorationImage(
                  image: assetProvider(imageBg), fit: BoxFit.cover)),
          child: Padding(
        ...
        builder: (context, constraints) {
          ...
          if (aspectRatio > imgAspect) {
            return Flow(
                ...
                children: [
                  fadeAssetBg(imageBg,
                      fit: BoxFit.scaleDown, key: _backgroundImageKey),
                ]);
          } else {
            return SizedBox(
  ...
  Widget glassAndText(BuildContext context) {
    ...
    //     widthFactor: .5,
    //     heightFactor: 1,
    //     child: Center(child: glassAndTextContent()));
