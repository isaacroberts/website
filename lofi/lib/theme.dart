...
const MaterialColor primary = primarySwatch;

const Color MANIFEST_THEME_COLOR = Primary_;
const Color MANIFEST_BACKGROUND_COLOR = Dark_;

const MaterialColor secondary = secSwatch;
