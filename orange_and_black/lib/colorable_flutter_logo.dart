...
//If you want to animate these colors, set up an AnimatedBuilder with a key as so
/*
AnimatedBuilder(
            animation: colorData,
            builder: (context, _) {
            Color primary = colorData.primary;
            Color secondary = colorData.secondary;
            return ColoredFlutterLogo(
                key: ValueKey<String>(primary.value.toString() +
                    secondary.value.toString()),
                topColor: primary,
                botColor: secondary,
                );}
 */
class ColoredFlutterLogo extends StatelessWidget {
  const ColoredFlutterLogo({
    super.key,
    this.size,
    this.textColor = const Color(0xFF757575),
    this.topColor = const Color(0xff027DFD),
    this.botColor = const Color(0xff042B59),
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      duration: duration,
      curve: curve,
      decoration: ColoredFlutterLogoDecoration(
        style: style,
        textColor: textColor,
        topColor: topColor,
        botColor: botColor,
...
class ColoredFlutterLogoDecoration extends Decoration {
  ...
  const ColoredFlutterLogoDecoration({
    this.textColor = const Color(0xFF757575),
  ...
  const ColoredFlutterLogoDecoration._(this.textColor, this.topColor,
      this.botColor, this.style, this.margin, this._position, this._opacity);
  ...
  static ColoredFlutterLogoDecoration? lerp(ColoredFlutterLogoDecoration? a,
      ColoredFlutterLogoDecoration? b, double t) {
    ...
    if (a == null) {
      return ColoredFlutterLogoDecoration._(
        b!.textColor,
        b.topColor,
        b.botColor,
        b.style,
    ...
    return ColoredFlutterLogoDecoration._(
      ...
      Color.lerp(a.botColor, b.botColor, t)!,
  ...
  @override
  ColoredFlutterLogoDecoration? lerpFrom(Decoration? a, double t) {
    assert(debugAssertIsValid());
    if (a == null || a is ColoredFlutterLogoDecoration) {
      assert(a == null || a.debugAssertIsValid());
      return ColoredFlutterLogoDecoration.lerp(
          a as ColoredFlutterLogoDecoration?, this, t);
    }
    return super.lerpFrom(a, t) as ColoredFlutterLogoDecoration?;
  }

  @override
  ColoredFlutterLogoDecoration? lerpTo(Decoration? b, double t) {
    assert(debugAssertIsValid());
    if (b == null || b is ColoredFlutterLogoDecoration) {
      assert(b == null || b.debugAssertIsValid());
      return ColoredFlutterLogoDecoration.lerp(
          this, b as ColoredFlutterLogoDecoration?, t);
    }
    return super.lerpTo(b, t) as ColoredFlutterLogoDecoration?;
  }
  ...
  BoxPainter createBoxPainter([VoidCallback? onChanged]) {
    assert(debugAssertIsValid());
    return _ColoredFlutterLogoPainter(this);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is ColoredFlutterLogoDecoration &&
...
class _ColoredFlutterLogoPainter extends BoxPainter {
  _ColoredFlutterLogoPainter(this._config)
      : assert(_config.debugAssertIsValid()),
        super(null) {
    _prepareText();
  }

  final ColoredFlutterLogoDecoration _config;
  ...
  void _paintLogo(Canvas canvas, Rect rect) {
    ...
    // Set up the styles.
    Color midPt =
        Color.lerp(_config.topColor, _config.botColor, .5) ?? _config.topColor;

    final Paint lightPaint = Paint()..color = _config.topColor;
    final Paint mediumPaint = Paint()..color = midPt;
    final Paint darkPaint = Paint()..color = _config.botColor;
    ...
    final ui.Gradient triangleGradient = ui.Gradient.linear(
      ...
      <Color>[
        _config.botColor.withOpacity(0),
        _config.botColor.darken(),
      ],
    );
